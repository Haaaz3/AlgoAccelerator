...
SELECT 'vs-office-visit-' || m.id, m.id, '2.16.840.1.113883.3.464.1003.101.12.1001', 'Office Visit', '20240101', 'NCQA', 1
...
-- Hospice Value Set
INSERT INTO measure_value_set (id, measure_id, oid, name, version, publisher, verified)
SELECT 'vs-hospice-' || m.id, m.id, '2.16.840.1.113883.3.526.3.1584', 'Hospice Care Ambulatory', '20240101', 'AMA-PCPI', 1
FROM measure m WHERE m.id IN ('cms122-v12', 'cms124-v12', 'cms125-v12', 'cms127-v12', 'cms130-v12', 'cms165-v12');

-- Diabetes Value Set
INSERT INTO measure_value_set (id, measure_id, oid, name, version, publisher, verified)
VALUES ('vs-diabetes-cms122', 'cms122-v12', '2.16.840.1.113883.3.464.1003.103.12.1001', 'Diabetes', '20240101', 'NCQA', 1);
...
-- HbA1c Value Set
INSERT INTO measure_value_set (id, measure_id, oid, name, version, publisher, verified)
VALUES ('vs-hba1c-cms122', 'cms122-v12', '2.16.840.1.113883.3.464.1003.198.12.1013', 'HbA1c Laboratory Test', '20240101', 'NCQA', 1);
...
INSERT INTO measure_value_set (id, measure_id, oid, name, version, publisher, verified)
VALUES ('vs-mammo-cms125', 'cms125-v12', '2.16.840.1.113883.3.464.1003.108.12.1018', 'Mammography', '20240101', 'NCQA', 1);
...
INSERT INTO measure_value_set (id, measure_id, oid, name, version, publisher, verified)
VALUES ('vs-colon-cms130', 'cms130-v12', '2.16.840.1.113883.3.464.1003.108.12.1020', 'Colonoscopy', '20240101', 'NCQA', 1);
...
INSERT INTO measure_value_set (id, measure_id, oid, name, version, publisher, verified)
VALUES ('vs-htn-cms165', 'cms165-v12', '2.16.840.1.113883.3.464.1003.104.12.1011', 'Essential Hypertension', '20240101', 'NCQA', 1);
