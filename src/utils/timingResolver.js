 ...
 */
export function formatTimingExpression(timing                  )         {
...
function parseBoundary(text        )                        {
  ...
  if (offsetMatch) {
    ...
    const direction = offsetMatch[3].toLowerCase()                      ;
 ...
 */
export function formatBoundary(boundary                )         {
 ...
 */
export function formatTimingWindow(window              )         {
