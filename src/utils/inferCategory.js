 ...
 */
function isAssessmentValueSet(valueSet                   )          {
  const name = valueSet.name.toLowerCase();
 ...
 */
function isExclusionComponent(component                  )          {
 ...
 */
function inferFromValueSet(valueSet                   )                           {
  const name = valueSet.name.toLowerCase();
 ...
 */
export function inferCategory(component                                      )                    {
