...
export function ValueSetManager() {
  ...
  const [selectedValueSet, setSelectedValueSet] = useState                           (null);
      ...
      measure.valueSets.forEach(vs => {
        ...
        if (existing) {
          ...
          vsMap.set(key, {
            ...
            primaryCodeSystem: primarySystem                        ,
          });
        }
      });
    });
...
function CreateValueSetModal({ onClose }                         ) {
...
function getSystemBgColor(system        )         {
  switch (system) {
