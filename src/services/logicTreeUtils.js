 ...
 */
export function getAllCriteria(clause               )                {
  const criteria                = [];
 ...
 */
export function getAllGroups(clause               )                  {
  const groups                  = [];
 ...
 */
export function getTreeDepth(clause               )         {
  let maxDepth = 0;
...
export function isLogicalClause(node                             )                        {
  return 'operator' in node && 'children' in node && Array.isArray((node                 ).children);
}
 ...
 */
export function validateLogicTree(clause                                  )                      {
  const errors                   = [];
  const warnings                     = [];
  let criteriaCount = 0;
  let groupCount = 0;
 ...
 */
export function treeToFlat(clause               )                  {
  const items                  = [];
 ...
 */
export function generateNaturalLanguage(clause               )         {
 ...
 */
export function flattenTree(clause               )                {
 ...
 */
export function getPopulationLogicTree(pop                      )                       {
 ...
 */
export function hasValidCriteria(pop                      )          {
 ...
 */
export function getPopulationLogicSummary(pop                      )   
...
export function areTreesEqual(
  ...
  for (let i = 0; i < tree1.children.length; i++) {
    ...
    if (isClause1 && isClause2) {
      if (!areTreesEqual(child1                 , child2                 )) {
        return false;
      }
    } else {
