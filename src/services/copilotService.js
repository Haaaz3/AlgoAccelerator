...
export function buildCopilotSystemPrompt(context) {
  const lines = [
    `You are the AND/OR.ai Co-Pilot embedded in Insight Forge, a clinical quality measure (CQM) authoring tool used by clinical informaticists and healthcare engineers.`,
    ``,
