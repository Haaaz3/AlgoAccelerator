 ...
 */
export function intervalTemplate(interval             )         {
 ...
 */
export function timingTemplate(timing                 )         {
 ...
 */
export function resourceQueryTemplate(query                  )         {
 ...
 */
export function existsQueryTemplate(query                  )         {
 ...
 */
export function unionQueriesTemplate(queries                    )         {
  if (queries.length === 0) {
 ...
 */
export function libraryHeaderTemplate(header                  )         {
  const lines           = [];
 ...
 */
export function valueSetDeclarationsTemplate(valueSets                          )         {
  if (valueSets.length === 0) {
    return '// No value sets defined\n';
  }

  const lines           = ['// Value Sets'];
 ...
 */
export function parametersTemplate(params                )         {
  if (params.length === 0) {
    return '';
  }
 ...
 */
export const STANDARD_CODE_SYSTEMS                  = [
 ...
 */
export function ageAtEndOfMPTemplate()                {
  return {
 ...
 */
export function ageRangeCheckTemplate(min        , max        )                {
  return {
 ...
 */
export function genderCheckTemplate(gender                   )                {
  return {
 ...
 */
export function hospiceCheckTemplate()                {
  return {
 ...
 */
export function supplementalDataTemplate()         {
  return `
 ...
 */
export function crcScreeningTemplates()                  {
  return [
    {
 ...
 */
export function cervicalScreeningTemplates()                  {
  return [
    {
 ...
 */
export function breastScreeningTemplates()                  {
  return [
    {
 ...
 */
export function validateCQLExpression(expression        )                                       {
  const errors           = [];
...
export function buildCQLLibrary(builder                   )         {
  const parts           = [];
