 ...
 */
export function parseCqlContent(cqlContent        )                 {
  const valueSets                   = [];
  const codes               = [];
  const codeSystems                     = [];

  // Build code system lookup for resolving code references
  const codeSystemLookup                         = {};
 ...
 */
export function normalizeCodeSystem(systemName        )         {
  const systemMap                         = {
    'SNOMEDCT': 'SNOMED',
    'SNOMED': 'SNOMED',
    'SNOMED-CT': 'SNOMED',
 ...
 */
export function parseCqlFromDocument(documentContent        )                 {
  const allResults                 = {
    valueSets: [],
    codes: [],
    codeSystems: [],
