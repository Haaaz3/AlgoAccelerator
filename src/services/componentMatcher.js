...
function buildAtomicIdentityKey(component   
  ...
  const oid =
    ...
    (component                                              ).valueSetOid ??
    '';

  // Use valueSetName as fallback identifier when OID is missing
  const name =
    (component                   ).valueSet?.name ??
    (component                                               ).valueSetName ??
    '';
 ...
 */
function buildCompositeIdentityKey(component                    )                          {
 ...
 */
function buildParsedCompositeIdentityKey(parsed                 )                          {
 ...
 */
export function generateComponentHash(component                  )         {
  let identityKey                         ;
 ...
 */
export function generateParsedComponentHash(parsed                 )         {
  let identityKey                         ;
 ...
 */
function normalizeValueSetName(name        )         {
  return name
    .toLowerCase()
    .trim()
 ...
 */
function computeSimilarity(incoming                 , existing                  )         {
 ...
 */
export function areComponentsIdentical(a                  , b                  )          {
 ...
 */
export function parseDataElementToComponent(element             )                         {
  ...
  if (element.timingRequirements && element.timingRequirements.length > 0) {
    ...
    let unit                                                   ;
    let position                                          ;
    let reference         = 'Measurement Period';
