...
import { generateCQL,                          } from './cqlGenerator';
import { generateHDISQL,                          } from './hdiSqlGenerator';
import { validateCQLSyntax,                          } from './cqlValidator';
...
function createDemographicsOnlyMeasure()                       {
  return {
    metadata: {
...
function createConditionBasedMeasure()                       {
  return {
    metadata: {
...
function createProcedureBasedMeasure()                       {
  return {
    metadata: {
...
function createObservationBasedMeasure()                       {
  return {
    metadata: {
...
function createMultiPopulationMeasure()                       {
  return {
    metadata: {
 ...
 */
export function generateTestReport(suite                      )             {
  return {
 ...
 */
export function quickTestMeasure(measure                      )   
