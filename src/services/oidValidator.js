 ...
 * Validate OID format
 */
export function validateOIDFormat(oid        )                                     {
 ...
 */
export function fuzzyMatchNames(name1        , name2        )   
 ...
 */
function findSimilarOIDs(oid        , maxDistance         = 2)                 {
  const similar                 = [];
...
export function getCatalogOIDs()           {
