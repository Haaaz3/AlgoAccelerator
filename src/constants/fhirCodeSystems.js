 ...
 */
export function getCodeSystemDisplayName(uri        )         {
  switch (uri) {
    case ICD10CM:
      return 'ICD-10-CM';
    case SNOMEDCT:
 ...
 */
export function toFhirUri(system        )         {
  // Already a full URI
 ...
 */
export function codeSystemsMatch(system1        , system2        )          {
