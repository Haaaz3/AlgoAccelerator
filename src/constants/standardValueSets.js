 ...
 */
export const COLONOSCOPY_VALUE_SET                   = {
  id: 'colonoscopy',
 ...
 */
export const FIT_DNA_VALUE_SET                   = {
  id: 'fit-dna',
 ...
 */
export const FLEXIBLE_SIGMOIDOSCOPY_VALUE_SET                   = {
 ...
 */
export const CT_COLONOGRAPHY_VALUE_SET                   = {
  id: 'ct-colonography',
 ...
 */
export const PAP_TEST_VALUE_SET                   = {
  id: 'pap-test',
 ...
 */
export const HPV_TEST_VALUE_SET                   = {
  id: 'hpv-test',
 ...
 */
export const HYSTERECTOMY_NO_CERVIX_VALUE_SET                   = {
 ...
 */
export const CERVICAL_CANCER_VALUE_SET                   = {
  id: 'cervical-cancer',
 ...
 */
export const COLORECTAL_CANCER_VALUE_SET                   = {
 ...
 */
export const TOTAL_COLECTOMY_VALUE_SET                   = {
  id: 'total-colectomy',
 ...
 */
export const HOSPICE_CARE_VALUE_SET                   = {
  id: 'hospice-care',
 ...
 */
export const HOSPICE_CARE_AMBULATORY_VALUE_SET                   = {
 ...
 */
export const FRAILTY_VALUE_SET                   = {
  id: 'frailty',
 ...
 */
export const DEMENTIA_VALUE_SET                   = {
  id: 'dementia',
 ...
 */
export const ADMINISTRATIVE_GENDER_VALUE_SET                   = {
 ...
 */
export const DTAP_VACCINE_VALUE_SET                   = {
  id: 'dtap-vaccine',
 ...
 */
export const IPV_VACCINE_VALUE_SET                   = {
  id: 'ipv-vaccine',
 ...
 */
export const MMR_VACCINE_VALUE_SET                   = {
  id: 'mmr-vaccine',
 ...
 */
export const HIB_VACCINE_VALUE_SET                   = {
  id: 'hib-vaccine',
 ...
 */
export const HEPATITIS_B_VACCINE_VALUE_SET                   = {
  id: 'hep-b-vaccine',
 ...
 */
export const VARICELLA_VACCINE_VALUE_SET                   = {
 ...
 */
export const PCV_VACCINE_VALUE_SET                   = {
  id: 'pcv-vaccine',
 ...
 */
export const HEPATITIS_A_VACCINE_VALUE_SET                   = {
  id: 'hep-a-vaccine',
 ...
 */
export const ROTAVIRUS_VACCINE_VALUE_SET                   = {
 ...
 */
export const INFLUENZA_VACCINE_VALUE_SET                   = {
 ...
 */
export function getChildhoodImmunizationValueSets()                     {
  return [
 ...
 */
export function getChildhoodImmunizationExclusionValueSets()                     {
  return [
 ...
 */
export function getCRCScreeningNumeratorValueSets()                     {
  return [
 ...
 */
export function getCRCScreeningExclusionValueSets()                     {
  return [
 ...
 */
export function getCervicalScreeningNumeratorValueSets()                     {
  return [
    PAP_TEST_VALUE_SET,
    HPV_TEST_VALUE_SET,
  ];
 ...
 */
export function getCervicalScreeningExclusionValueSets()                     {
  return [
 ...
 */
export const MAMMOGRAPHY_VALUE_SET                   = {
  id: 'mammography',
 ...
 */
export function getBreastCancerScreeningNumeratorValueSets()                     {
  return [
 ...
 */
export const STANDARD_VALUE_SETS_BY_MEASURE                  
 ...
 */
export function getAllStandardValueSets()                     {
  return [
    // Demographics
 ...
 */
export function searchStandardValueSets(query        )                     {
